...
loc_dat = '/pscratch/sd/h/hebina/IBIS/selection_clustering/catalogs/clustering_cat_v4_bright.fits' # target file
...
fig.tight_layout()    
fig.savefig('plots/wR_5bin_bright_v4.png')
fig.show()
out_file = open("wR_v4/lae_5bins_bright.json", "w")
